...
- Prior : 사전 분포를 통해서 데이터를 추정함. Trajectory를 sampling할 때는 Prior를 통해 추출된 특징인 Latent Vector를 decoder에 전달한 후 다음 Trajectory를 생성함. $$𝑝_𝜃 (𝑧_𝑡│𝑥_{<𝑡}, 𝑧_{<𝑡} )= 𝜑_{𝑝𝑟𝑖𝑜𝑟} (ℎ_{𝑡−1})$$
